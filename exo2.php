...
<html lang="fr">
    ...
    <body>
        <div class="container">
            <h1>ExoPhp2 - Partie7</h1>
            <p>Créer un formulaire demandant <b>le nom</b> et <b>le prénom</b>. 
                <br />Ce formulaire doit rediriger vers la page <b>user2.php</b> avec la méthode <b>POST</b>.</p>
        </div>    
        <div class="container">
            <form name="inscription" method="post" action="user2.php">
             ...
             <input type="submit" name="valid" value="Envoyer" href="user2.php"/>
           </form>
        </div>
